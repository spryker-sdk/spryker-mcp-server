...
describe('Get Checkout Data Tool', () => {
    ...
    describe('successful data retrieval', () => {
        it('should retrieve checkout data with all included information', async () => {
            ...
            expect(mockPost).toHaveBeenCalledWith('checkout-data?include=payment-methods,shipments,shipment-methods,addresses', {
                data: {
                    type: 'checkout-data',
                    attributes: {
                        idCart: 'cart-123'
...
//# sourceMappingURL=get-checkout-data.test.js.map