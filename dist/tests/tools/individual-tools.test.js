...
describe('Individual Tools', () => {
    ...
    describe('addToCartTool', () => {
        it('should add item to cart', async () => {
            ...
            expect(mockGet).toHaveBeenCalledWith('carts', 'customer-token');
            expect(mockPost).toHaveBeenCalledWith('carts/cart-123/items', {
                data: {
                    type: 'items',
                    attributes: {
                        sku: 'SKU-001',
    ...
    describe('removeFromCartTool', () => {
        it('should remove item from cart', async () => {
            ...
            expect(mockDelete).toHaveBeenCalledWith('carts/cart-123/items/item-456', 'customer-token');
            expect(result.content).toHaveLength(1);
            expect(result.content[0]?.text).toContain('"success": true');
        });
    ...
    describe('updateCartItemTool', () => {
        it('should update cart item quantity', async () => {
            ...
            expect(mockPatch).toHaveBeenCalledWith('carts/cart-123/items/item-456', expect.objectContaining({
    ...
    describe('guestAddToCartTool', () => {
        it('should add item to guest cart', async () => {
            ...
            expect(mockPost).toHaveBeenCalledWith('guest-cart-items', expect.objectContaining({
                data: expect.objectContaining({
...
//# sourceMappingURL=individual-tools.test.js.map