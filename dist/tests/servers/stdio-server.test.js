...
describe('StdioMCPServer', () => {
    ...
    beforeEach(() => {
        ...
        stdioServer = new StdioMCPServer({ transport: 'stdio' }, mockHandlerRegistrar);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    ...
    describe('start', () => {
        ...
        test('should handle server connection error', async () => {
            ...
            expect(mockLogger.error).toHaveBeenCalledWith('Failed to start stdio server:', expect.any(Error));
        });
    });
    describe('shutdown', () => {
        ...
        test('should handle shutdown error gracefully', async () => {
            ...
            expect(mockLogger.error).toHaveBeenCalledWith('Error during stdio server shutdown:', expect.any(Error));
        });
    });
...
//# sourceMappingURL=stdio-server.test.js.map