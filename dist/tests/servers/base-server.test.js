...
describe('BaseServer', () => {
    ...
    beforeEach(() => {
        ...
        mockPromptRegistry = promptRegistry;
    ...
    describe('tool call handler', () => {
        ...
        beforeEach(() => {
            ...
            const toolCallHandlerCall = setRequestHandlerCalls.find((call) => call[0] === CallToolRequestSchema);
        ...
        it('should handle non-Error exceptions', async () => {
            ...
            expect(mockLogger.error).toHaveBeenCalledWith('Tool failing-tool execution failed:', expect.any(Error));
        });
    });
    describe('prompt list handler', () => {
        ...
        beforeEach(() => {
            ...
            const setRequestHandlerCalls = mockServer.setRequestHandler.mock.calls;
            const promptListHandlerCall = setRequestHandlerCalls.find((call) => call[0] === ListPromptsRequestSchema);
    ...
    describe('prompt get handler', () => {
        let promptGetHandler;
        beforeEach(() => {
            // Get the prompt get handler that was registered
            const setRequestHandlerCalls = mockServer.setRequestHandler.mock.calls;
            const promptGetHandlerCall = setRequestHandlerCalls.find((call) => call[0] === GetPromptRequestSchema);
        ...
        it('should handle non-Error exceptions in prompt generation', async () => {
            ...
            expect(mockLogger.error).toHaveBeenCalledWith('Prompt failing-prompt generation failed:', expect.any(Error));
        });
    });
    describe('set level handler', () => {
        ...
        beforeEach(() => {
            ...
            const setRequestHandlerCalls = mockServer.setRequestHandler.mock.calls;
            const setLevelHandlerCall = setRequestHandlerCalls.find((call) => call[0] === SetLevelRequestSchema);
        ...
        it('should handle non-Error exceptions in set level', async () => {
            ...
            expect(mockLogger.error).toHaveBeenCalledWith('Failed to set log level to invalid:', expect.any(Error));
        });
    });
...
//# sourceMappingURL=base-server.test.js.map