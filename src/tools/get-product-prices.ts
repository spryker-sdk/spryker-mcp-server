...
async function getProductPrices(args: z.infer<typeof GetProductPricesSchema>) {
  ...
  try {
    ...
    logger.error('Get product prices failed', error as Error);
