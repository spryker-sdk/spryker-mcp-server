 ...
 */
async function searchProducts(args: ProductSearchInput) {
  ...
  try {
      ...
      data: Array<{
        ...
        attributes: {
          abstractProducts: Array<{
            ...
            images?: Array<{ externalUrlSmall?: string; externalUrlLarge?: string }>;
          }>;
          pagination?: {
            numFound: number;
            currentPage: number;
          ...
          sort?: {
            ...
            "sortParamLocalizedNames": Array<{[key: string]: string}>;
    ...
    }>('GET', 'catalog-search', { params: queryParams });
