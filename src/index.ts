...
import { TransportType, ServerOptions, MCPServer, HandlerRegistrar } from './servers/types.js';

/**
 * Create handler registration function for tools and prompts
 */
function createHandlerRegistrar(): HandlerRegistrar {
...
function parseArgs(): ServerOptions {
  ...
  const options: ServerOptions = {
    transport: (config.mcp.transport as TransportType) || 'stdio'
  };
