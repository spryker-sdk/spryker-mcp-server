...
import { SprykerApiService, ApiError } from '../../src/services/spryker-api';
...
describe('getOrderTool', () => {
  let mockApiService: jest.Mocked<SprykerApiService>;
  ...
  describe('handler', () => {
    ...
    it('should retrieve specific order by reference', async () => {
      ...
      expect(mockApiService.get).toHaveBeenCalledWith(
        'orders/DE--123?include=order-items,product-concrete',
        'customer-token'
      );
